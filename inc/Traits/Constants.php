...
trait Constants {
	...
	public static string $classes_endpoint_namespace2 = 'get_gym_builder_classes_json/v1';
	public static string $trainers_endpoint_namespace = 'get_gym_builder_trainers/v1';
